...
🚀 Emby/Jellyfin 媒体库自动化管理工具。本项目提供了一个优雅的 Web 界面，用于管理Strm文件生成、Emby管理、刮削视频以及媒体库同步任务。
 ...
 *   ⛓️ **302 重定向**：使用emby2alist中间件，访问代理端口播放视频即可实现302重定向
...
## 📸 界面预览
 ![数据面板](./scr/QQ_1786533050850.png)
 ![媒体总览](./scr/QQ_1786533510142.png)
 ![海报生成](./scr/QQ_1786533537805.png) 
 ![同步目录](./scr/QQ_1786533082332.png)
 ![ed2k生成](./scr/QQ_1786533468937.png)
